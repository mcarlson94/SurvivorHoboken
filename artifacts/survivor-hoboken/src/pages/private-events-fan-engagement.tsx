        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="mt-20 bg-foreground border-4 border-foreground brutal-shadow text-center px-8 py-16">
            ...
            <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto mb-4">
              We bring life-size, authentic Survivor immunity challenges directly to your concourse, field, or event floor. Fans compete head-to-head: real energy, real competition, real Survivor.
            </p>
