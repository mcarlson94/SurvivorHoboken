        ...
        <div className="container mx-auto max-w-3xl space-y-6 text-lg text-foreground/80 leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="pt-4">
            ...
            <blockquote
              ...
              data-instgrm-permalink="https://www.instagram.com/reel/DOmSWaVCSI8/?utm_source=ig_embed&utm_campaign=loading"
            ...
            >
              <div style={{ padding: 16 }}>
                <a
                  href="https://www.instagram.com/reel/DOmSWaVCSI8/?utm_source=ig_embed&utm_campaign=loading"
                  target="_blank"
